...
//            Video_printNumAt(1, 24, VIDEO_FGND_YELLOW, key);
        ...
        case 10: {                                                   /* '9' */
            ...
            ke->key_code = '0' + (key - 1);
            QActive_postFIFO(AO_UI, (QEvent *)ke);
            break;
        }
        case 11: {                                                   /* '0' */
        ...
        case 46: {                                                   /* 'c' */
            ...
            QActive_postFIFO(AO_UI, (QEvent *)&ce);
            break;
        }
        case 18: {                                                   /* 'e' */
            static QEvent const cee = { CE_SIG, 0 };
            QActive_postFIFO(AO_UI, (QEvent *)&cee);
            break;
        }
        case 28: {                                                 /* ENTER */
            static QEvent const ee = { ENTER_SIG, 0 };
            QActive_postFIFO(AO_UI, (QEvent *)&ee);
            break;
        }
        case 200: {                                             /* UP-arrow */
            static QEvent const ue = { UP_SIG, 0 };
            QActive_postFIFO(AO_UI, (QEvent *)&ue);
            break;
        }
        case 208: {                                           /* DOWN-arrow */
            static QEvent const de = { DOWN_SIG, 0 };
            QActive_postFIFO(AO_UI, (QEvent *)&de);
            break;
        }
        case 59: {                                                    /* F1 */
            static QEvent const he = { HELP_SIG, 0 };
            QActive_postFIFO(AO_UI, (QEvent *)&he);
            break;
        }
        case 129: {                                                  /* ESC */
