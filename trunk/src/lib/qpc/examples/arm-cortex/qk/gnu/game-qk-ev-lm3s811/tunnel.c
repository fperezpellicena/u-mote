...
static QState Tunnel_initial          (Tunnel *me, QEvent const *e);
static QState Tunnel_final            (Tunnel *me, QEvent const *e);
static QState Tunnel_active           (Tunnel *me, QEvent const *e);
static QState Tunnel_playing          (Tunnel *me, QEvent const *e);
static QState Tunnel_demo             (Tunnel *me, QEvent const *e);
static QState Tunnel_game_over        (Tunnel *me, QEvent const *e);
static QState Tunnel_screen_saver     (Tunnel *me, QEvent const *e);
static QState Tunnel_screen_saver_hide(Tunnel *me, QEvent const *e);
static QState Tunnel_screen_saver_show(Tunnel *me, QEvent const *e);
...
static void Tunnel_addImageAt(Tunnel *me, uint8_t bmp,
                              uint8_t x, int8_t y);
static void Tunnel_dispatchToAllMines(Tunnel *me, QEvent const *e);
...
/* HSM definition ----------------------------------------------------------*/
/*..........................................................................*/
QState Tunnel_initial(Tunnel *me, QEvent const *e) {
    uint8_t n;

    (void)e;                  /* avoid the "unreferenced parameter" warning */

    for (n = 0; n < GAME_MINES_MAX; ++n) {
        QHsm_init(me->mine1_pool[n], (QEvent *)0);/*initial tran. for Mine1 */
        QHsm_init(me->mine2_pool[n], (QEvent *)0);/*initial tran. for Mine2 */
    }
...
/*..........................................................................*/
QState Tunnel_final(Tunnel *me, QEvent const *e) {
...
/*..........................................................................*/
QState Tunnel_active(Tunnel *me, QEvent const *e) {
    switch (e->sig) {
...
/*..........................................................................*/
QState Tunnel_demo(Tunnel *me, QEvent const *e) {
    switch (e->sig) {
        case Q_ENTRY_SIG: {
...
/*..........................................................................*/
QState Tunnel_game_over(Tunnel *me, QEvent const *e) {
    switch (e->sig) {
        case Q_ENTRY_SIG: {
            QTimeEvt_postEvery(&me->blinkTimeEvt, (QActive *)me,
...
/*..........................................................................*/
QState Tunnel_playing(Tunnel *me, QEvent const *e) {
    uint8_t x;
    int8_t y;
    uint8_t bmp;
...
QState Tunnel_screen_saver(Tunnel *me, QEvent const *e) {
    switch (e->sig) {
        case Q_INIT_SIG: {
...
/*..........................................................................*/
QState Tunnel_screen_saver_hide(Tunnel *me, QEvent const *e) {
    switch (e->sig) {
        case Q_ENTRY_SIG: {
...
/*..........................................................................*/
QState Tunnel_screen_saver_show(Tunnel *me, QEvent const *e) {
    switch (e->sig) {
        case Q_ENTRY_SIG: {
            uint32_t rnd = random();
...
void Tunnel_plantMine(Tunnel *me) {
        ...
        && (rnd < 8))                /* place the mines only 5% of the time */
    {
        ...
        if (n < Q_DIM(me->mines)) {               /* a disabled Mine found? */
            ...
            QHsm_dispatch(me->mines[n], (QEvent *)&ope); /* direct dispatch */
        }
    }
}
/*..........................................................................*/
void Tunnel_dispatchToAllMines(Tunnel *me, QEvent const *e) {
    uint8_t n;
