...
rem QEP ----------------------------------------------------------------------
set QEP_DIR=..\..\qep
%PC_LINT_DIR%\lint-nt %LINTFLAGS% -i%QEP_DIR%\source %QEP_DIR%\lint\opt_qep.lnt -os(lint_qep.txt) %QEP_DIR%\source\*.c

rem QF -----------------------------------------------------------------------
set QF_DIR=..\..\qf
%PC_LINT_DIR%\lint-nt %LINTFLAGS% -i%QF_DIR%\source %QF_DIR%\lint\opt_qf.lnt -os(lint_qf.txt) %QF_DIR%\source\*.c

rem QK ----------------------------------------------------------------------
set QK_DIR=..\..\qk
%PC_LINT_DIR%\lint-nt %LINTFLAGS% -i%QK_DIR%\source %QK_DIR%\lint\opt_qk.lnt -os(lint_qk.txt) %QK_DIR%\source\*.c

rem QS ----------------------------------------------------------------------
set QS_DIR=..\..\qs
%PC_LINT_DIR%\lint-nt %LINTFLAGS% -DQ_SPY -i%QS_DIR%\source %QS_DIR%\lint\opt_qs.lnt -os(lint_qs.txt) %QS_DIR%\source\*.c
