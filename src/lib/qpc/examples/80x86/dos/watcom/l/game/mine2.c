...
QState Mine2_used(Mine2 *me, QEvent const *e) {
    switch (e->sig) {
        case Q_EXIT_SIG: {
            ...
            mev->id = MINE_ID(me);
            QACTIVE_POST(AO_Tunnel, (QEvent *)mev, me);
            return Q_HANDLED();
        }
    ...
    switch (e->sig) {
        case TIME_TICK_SIG: {
            if (me->x >= GAME_SPEED_X) {
                ...
                oie->y   = me->y;
                oie->bmp = MINE2_BMP;
                QACTIVE_POST(AO_Tunnel, (QEvent *)oie, me);
            }
            else {
                return Q_TRAN(&Mine2_unused);
            }
        ...
        case SHIP_IMG_SIG: {
            ...
            if (do_bitmaps_overlap(MINE2_BMP, me->x, me->y, bmp, x, y)) {
                ...
                QACTIVE_POST(AO_Ship, (QEvent *)&mine2_hit, me);
            ...
            */
                                   ...
                                   me->x, me->y, bmp, x, y))
            {
               static ScoreEvt const mine2_destroyed = {
                ...
                QACTIVE_POST(AO_Missile, (QEvent *)&mine2_destroyed, me);
